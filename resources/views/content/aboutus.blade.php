<x-app>
    ...
    <section class="min-h-screen flex items-center justify-center bg-center bg-cover"
        ...
        <div class="max-w-5xl mx-auto text-center flex flex-col items-center justify-center px-6 py-16 space-y-10">
            ...
            <div class="relative w-full">
                <img src="{{ asset('img/cloud.png') }}" alt="Cloud" class="w-full z-0">
                <p class="absolute z-10 inset-0 flex flex-col items-center justify-center text-gray-700 text-4xl sm:text-5xl md:text-6xl font-semibold">
    ...
    {{-- CONTACT SECTION --}}
    <section class="flex flex-col items-center justify-center py-16 bg-indigo-50 text-center space-y-3">
        <h1 class="text-3xl font-semibold text-gray-800 mb-2">Contact Us</h1>
        <p class="text-gray-600">📧 floralearn@gmail.com</p>
        <p class="text-gray-600">📱 @floralearn</p>
    </section>
    ...
    <section class="flex flex-col items-center justify-center py-16 bg-white text-center space-y-10">
        <div class="w-full flex items-center h-14 bg-indigo-200 ">
            <h1 class="w-full text-3xl font-semibold text-gray-800 bg-pink-200">Meet Our Instructor</h1>
        </div>
